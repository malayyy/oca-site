<template>
    <section id="about">
        <SimpleActionCard :title="'About Us'"
            :desc="'OCA SOLUTIONS Pvt. Ltd. is dedicated to provide technical consultancy and specialized services in the field of HVAC. OCA has always guided the customer to choose an appropriate air conditioning system for any environment. OCA believes in delivering highest standards of safety and reliability while designing, installing and maintaining the HVAC systems.'"
            :icon="icon" />
    </section>
</template>
